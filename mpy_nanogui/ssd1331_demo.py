...
from ssd1331_oled import oled  # Create a display instance
...
CWriter.set_textpos(oled, 0, 0)  # In case previous tests have altered it
wri = CWriter(oled, arial10, GREEN, BLACK, verbose=False)
wri.set_clip(True, True, False)

def meter():
    print('meter')
    refresh(oled, True)  # Clear any prior image
...
def multi_fields(t):
    ...
    for txt in ('X:', 'Y:', 'Z:'):
        ...
        nfields.append(Label(wri, y, col, width, bdcolor=True))  # Specify a border, color TBD
        y += dy
